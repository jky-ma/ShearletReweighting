function out = TVsolver(y,m,A,D,alpha,beta,mu1,mu2,varargin)
    %% Split Bregman/ADMM 
    ...
    %
    % Problem (2) is solved by using SB/ADMM iterations. 
